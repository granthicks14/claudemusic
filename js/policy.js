...
const DRUM_HEAVY = new Set(["trap", "drill", "phonk", "jerseyclub", "techno", "dnb", "dubstep", "rap", "rage", "metal", "edm"]);
const MELODIC = new Set(["neosoul", "rnb", "lofi", "amapiano", "synthwave", "afrobeats", "hiphop", "soul", "jazz", "ambient", "orchestral", "cinematic", "pop", "country", "pluggnb"]);
const ELECTRONIC = new Set(["house", "techno", "dnb", "dubstep", "synthwave", "ukgarage", "jerseyclub", "edm"]);
...
const HALF_TIME = new Set(["trap", "drill", "phonk", "dubstep", "jerseyclub", "rage"]);
